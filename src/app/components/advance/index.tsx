...
export const Advance = () => {
  ...
  return (
    <div className="mt-[60px] md:mt-0  pt-[60px] md:pt-0 flex flex-col gap-[8px] sm:gap-[20px] py-[60px] sm:py-[80px] lg:py-[120px] px-[16px] sm:px-[40px] lg:px-[60px]">
      <Card className="px-[18px] py-[18px] lg:px-[40px] lg:py-[30px] flex flex-col gap-[8px] sm:gap-[20px]  rounded-[32px] bg-[#DCE4F9]">
        <h4 className="font-[600] text-[20px] lg:text-[32px] text-[#1E344F]">
          {t("FirstDesktop.title")}
        </h4>
        <p className="text-[#1E344F] font-[500] text-[16px] lg:text-[18px]">
